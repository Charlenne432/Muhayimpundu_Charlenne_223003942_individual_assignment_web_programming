        ...
        <div class="container">
            <div class="hero-panel">
                ...
                <div class="hero-image">
                    <img src="image/photo.jpg (2)" alt="Hotel food display">
                </div>
            </div>
        </div>
    </div>
...
Welcome to our hotel, where comfort meets elegance and every stay becomes a memorable experience. Nestled in a serene and inviting environment, our hotel is designed to offer both relaxation and luxury to every guest. From beautifully furnished rooms to exceptional customer service, we take pride in creating a warm and welcoming atmosphere that feels like a home away from home. Whether you are visiting for business or leisure, our modern facilities, delicious cuisine, and dedicated staff ensure that your needs are met with care and professionalism. At our hotel, we don’t just provide a place to stay we create moments you’ll cherish.
        ...
        <div class="section menu-card" id="menu">
            ...
            <table>
                ...
                <tr><td>Fish</td><td>FRW25000</td></tr>
                <tr><td>Chicken rice</td><td>FRW25000 </td></tr>
                <tr><td>burger & Chips</td><td>FRW8000</td></tr>
                <tr><td>Coffee</td><td>FRW 2000</td></tr>
                <tr><td>Rolex</td><td>FRW 3500</td></tr>
                <tr><td>Milkshakes</td><td>FRW 2500</td></tr>
        ...
        <div class="section gallery-card" id="gallery">
            <h2>Gallery</h2>
            <div class="gallery">
                <a href="#order"><img src="image/photo.jpg" alt="Gallery image 1"></a>
                <a href="#order"><img src="image/photo.jpg (2)" alt="Gallery image 2"></a>
                <a href="#order"><img src="image/photo.jpg (3)" alt="Gallery image 3"></a>
                <a href="#order"><img src="image/photo.jpg (4)" alt="Gallery image 4"></a>
                <a href="#order"><img src="image/photo.jpg (5)" alt="Gallery image 5"></a>
                 <a href="#order"><img src="image/photo.jpg (6)" alt="Gallery image 5"></a>
            </div>
        </div>
        ...
        <div class="section order-card" id="order">
            ...
            <form action="order.php" method="post">
                ...
                <select name="menu" required>
                    ...
                    <option value="burger & Chips">burger & Chips</option>
